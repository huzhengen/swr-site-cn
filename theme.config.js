...
export default {
  ...
  footerText: <a href="https://vercel.com/?utm_source=swr-cn" target="_blank" rel="noopener" className="inline-flex items-center no-underline text-current font-semibold">
